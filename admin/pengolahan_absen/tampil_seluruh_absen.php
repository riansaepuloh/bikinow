...
<body class="flat-blue">
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-tasks"></i> Daftar Absen Keseluruhan Pegawai</h3>
            </div>
            <div class="box-body">
             <?php 
                include"../config/koneksi.php";
                $hasil=mysqli_query($koneksi,"SELECT `tanggal`,`nip`,`nama`,`nama_bagian`,`kd_absen`,`keterangan`,`lembur` FROM `t_pegawai` JOIN `t_bagian` USING(`kd_bagian`) JOIN`t_absen` USING(`nip`) ORDER BY `tanggal` DESC;");
             ?>
